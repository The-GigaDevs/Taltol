...
import cc from "../public/static/quoteCard.png";
...
user experience for quotes."
      ...
      <div className=" px-[10%] flex lg:flex-row flex-col-reverse items-center justify-evenly lg:items-center lg:justify-between w-full h-[80vh] lg:h-[50vh] ">
        <div className="w-[100%] lg:w-[60%] ">
          <button className="text-[4vw] lg:text-[1.14vw] onHoverButton text-[#828282] py-2 px-2 bg-white  rounded-[4px] flex items-center">
            <svg
              className="mx-1"
              width="21"
              height="18"
        ...
        <div className="w-[80%] lg:w-[30%]">
          <Image src={cc} placeholder="blur" alt="category-card"></Image>
        </div>
      </div>
