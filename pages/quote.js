  ...
  return (
    <div className="quote">
      <header className="quote-header">
        <span className="quote-header-close">
          <svg
      ...
      <div className="quote-body">
        <div className="quote-body-heading">
          <span className="quote-body-heading-topic">Confident quote </span>from
          <span className="quote-body-heading-author"> Frank Zappa</span>,
