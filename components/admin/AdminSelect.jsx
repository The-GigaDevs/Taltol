...
const AdminSelect = () => {
  ...
  return (
    <div className="admin-select">
      <div className="admin-select-content">
        <button
          type="button"
        ...
        <ul
          className={
            isOptionsOpen ? 'admin-select-options show' : 'admin-select-options'
          }
          role="listbox"
        ...
        >
          {optionsList.map((option, index) => (
            <li
              ...
              className="admin-select-options-item"
            >
              {option}
            </li>
          ))}
