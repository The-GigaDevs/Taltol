  ...
  return (
    <div className="account-mobile">
      {user ? (
          ...
          <div className="account-mobile-content">
            <div className="account-mobile-header">
              ...
              <div className="account-mobile-header-info">
                <h2 className="account-mobile-header-info-name">
                  {user?.name}
                </h2>
                <p className="account-mobile-header-info-date">
                  {user?.date_joined}
                </p>
                <p className="account-mobile-header-info-email">
                  {user?.email}
                </p>
              </div>
            </div>
        ...
        <div className="account-mobile-no-user">
          <Link href="/login" passHref>
            <button className="account-mobile-no-user-btn">Login/Signup</button>
          </Link>
        </div>
      )}
    </div>
